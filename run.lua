...
local cmake_variables =
   {
      ...
      BATTLESHIPS_MINIMUM_CXX_STANDARD   = 17,
      BATTLESHIPS_BUILD_DIR              = local_dirs.build,
      BATTLESHIPS_BINARY_DIR             = local_dirs.build_binaries,
      BATTLESHIPS_LIBRARY_DIR            = local_dirs.build_libraries,
      BATTLESHIPS_ARTIFACT_DIR           = local_dirs.build_artifacts,
      BATTLESHIPS_DEBUG_DIR              = local_dirs.build_debug,
      BATTLESHIPS_ENABLE_DEBUG           = true,
      BATTLESHIPS_USE_CCACHE             = true,
      BATTLESHIPS_USE_CLANG              = true,
      BATTLESHIPS_TEST_VAR               = "Hello, I'm an irrational value!"
   }
...
local function regenerate_variables()
   ...
   build_primary_executable_name = "battleships"
